...
class DownloadManager:
    ...
    def download(self, src, dst, is_file=None):
        extension = os.path.splitext(src)[1]
        if extension == "" and is_file is None:
            # is a directory
            action = "sync"
...
#         bucket_name="digitalverse-dev",
#         region_name="eu-central-1",
#         aws_access_key_id="AKIAU7XZOMYF45HBJGT4",
#         aws_secret_access_key="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",
#     )
#     manager.upload("/Users/max/temp/new_frame/00001.jpg", "/foobar/00001.jpg")
#     manager.download("/foobar", "/tmp/test/")
